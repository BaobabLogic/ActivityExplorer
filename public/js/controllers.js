...
function AppCtrl($scope, $http, $location) {
  ...
  $scope.themes = { 
    "left":    [
                  { 
                    "name": "Adventure",
                    "left": [  { "name": "Archery", "selected": true },
                               { "name": "Bushwalk", "selected": true }, 
                               { "name": "Hiking and Walking", "selected": true },
                               { "name": "Paint Ball", "selected": true }],
                    "right": [  { "name": "Shooting", "selected": true },
                                { "name": "Team Building", "selected": true }, 
                                { "name": "Tree adventure", "selected": true }],
                    "selected": true            
                  }, 
                  { 
                    "name": "Adventure Trips",
                    "left": [  { "name": "4x4 Trail", "selected": true },
                               { "name": "Day Drive", "selected": true },
                               { "name": "Game Drive", "selected": true }, 
                  ...
                  { 
                    "name": "Air",
                    "left": [  { "name": "Aerobatic Flight", "selected": true }, 
                               { "name": "Balloon Trip", "selected": true }, 
                               { "name": "Flying", "selected": true }],
                    "right": [  { "name": "Helicopter Trip", "selected": true }, 
                                { "name": "Microlight Flight", "selected": true }, 
                                { "name": "Scenic Flight", "selected": true }],
                    "selected": true
                  },
                  { 
                    "name": "Animal Experience",
                    "left": [  { "name": "Animal Interaction", "selected": true },  
                               { "name": "Aquarium", "selected": true },
                  ...
                  { 
                    ...
                    "left": [  { "name": "Art Experience", "selected": true },
                               { "name": "Cultural Experience", "selected": true },  
                               { "name": "Drumming", "selected": true }, 
                               { "name": "Ethnic Experience", "selected": true }],
                    "right": [  { "name": "Music Experience", "selected": true },
                                { "name": "Spa", "selected": true }, 
                                { "name": "Tribal Dancing", "selected": true }, 
    ...
    "right":  [  
                { 
                  "name": "Extreme Air",
                  "left": [ { "name": "Parachuting", "selected": true }, 
                ...
                { 
                  ...
                  "left": [  { "name": "2 Wheel Off-Road", "selected": true }, 
                             ...
                             { "name": "Bungy Swing", "selected": true },
                             { "name": "Kloofing", "selected": true }],
                  "right": [  { "name": "Rally Experience", "selected": true },
                              { "name": "Sail Karts", "selected": true }, 
                ...
                { 
                  "name": "Tours",
                  "left": [  { "name": "City Tour", "selected": true }, 
                             { "name": "Cycling", "selected": true }, 
                             { "name": "Educational Tour", "selected": true }, 
                             { "name": "Mine Tour", "selected": true }],
                  "right": [  { "name": "Sight Seeing Tour", "selected": true }, 
                              { "name": "Township Tour", "selected": true }, 
                              { "name": "Wine Tour", "selected": true }],
                  "selected": true
                },
                { 
                  "name": "Water Adventures",
                  "left": [  { "name": "Deep Sea Fishing", "selected": true }, 
                             { "name": "Fishing", "selected": true }, 
                             { "name": "Jetski", "selected": true },  
                             { "name": "Ocean Safari", "selected": true }, 
                             { "name": "Scuba Diving", "selected": true }],
                  "right": [  { "name": "Shark Cage Diving", "selected": true }, 
                              { "name": "Stand Up Paddle", "selected": true }, 
                ...
                { 
                  ...
                  "left": [  { "name": "Boat Charter", "selected": true }, 
                             { "name": "Boat Trip", "selected": true }, 
                             { "name": "Canoeing", "selected": true },
                             { "name": "Kayaking", "selected": true }],
                  "right": [ { "name": "Rafting", "selected": true }, 
